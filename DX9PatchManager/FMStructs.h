...
static UCHAR FMDX9_PARAM_HEADER[3] = { 0xf0,0x43,0x10 };	//Status,Yamaha ID, substatus
...
{
	UCHAR PatchName[FM_PATCH_NAME_SIZE];
};
...
struct FM_SINGLE_OLD_PATCH
{
	...
	FM_PITCH_ENVELOPE_OLD PitchEnvelope;
	FM_SINGLE_OLD_ALGORITHM Algorithm;
